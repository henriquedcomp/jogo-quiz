...
const perguntas = [
    ...
    adicionarQuestao("Qual das alternativas abaixo apenas contêm classes de palavras?", "Oxítona, paroxítona",  "Vogais, consoantes", "Artigo, verbo, sintaxe", "Substantivo, verbo, preposição ",  "Substantivo, verbo, preposição " ),
    ...
    adicionarQuestao("Um quilômetro equivale a quantos metros?",  "56 metros", "1000 metros", "100 metros", "10000 metros", "1000 metros" ),
    ...
    adicionarQuestao("O que representam os cinco anéis olímpicos?",  "Cinco tipos de esporte", "União dos 5 continentes", "Cinco deuses do Olimpo", "Os símbolos olímpicos", "União dos 5 continentes" ),
    ...
    adicionarQuestao("Quem escreveu Os Lusíadas?",  "Luís Vaz de Camões", "Fernando Pessoa", "Jorge Amado", "José de Alencar", "Luís Vaz de Camões" ),
